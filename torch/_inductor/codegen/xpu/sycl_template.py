...
from ...autotune_process import SYCLBenchmarkRequest, TensorMeta
from ...ir import Buffer, SYCLTemplateBuffer, IRNode, Layout
from ...utils import IndentedBuffer, unique
from ...virtualized import V
from ..common import KernelTemplate
from .sycl_kernel import SYCLTemplateCaller, SYCLTemplateKernel
...
class SYCLTemplate(KernelTemplate):
    ...
    def __init__(
        ...
        Baseclass for SYCL C++ Templates, derived from KernelTemplate. Not to be instantiated directly.

        Args:
            name (str): The name of the SYCLTemplate object.
    ...
    def generate(  # type: ignore[override]
        ...
        **kwargs,
        ...
        """
        Generates the SYCL template caller object for the given GEMM template and operation. This SYCLTemplateCaller
        may be used to call and benchmark the generated SYCL kernel in a standalone manner to enable Autotuning.

        Args:
            kwargs: Additional keyword arguments.

        Returns:
            A SYCLTemplateCaller object representing the generated SYCL template caller.
        """
        ...
        kernel_hash_name = f"xpu_{self.name}_{next(self.index_counter)}"
        ...
        def make_kernel_render(
            template_node: SYCLTemplateBuffer,
...
class CUTLASSTemplate(SYCLTemplate):
    """

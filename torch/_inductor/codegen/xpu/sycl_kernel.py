...
if TYPE_CHECKING:
    from .sycl_template import ArgInfo

from ...autotune_process import SYCLBenchmarkRequest
from ...ir import (
    Buffer,
    ChoiceCaller,
    SYCLTemplateBuffer,
...
if TYPE_CHECKING:
    from torch._inductor.codegen.xpu.sycl_template import SYCLTemplate
...
class SYCLKernel(Kernel):
    """
    Baseclass for SYCL / Cutlass based Kernels
    """
...
class SYCLTemplateKernel(SYCLKernel):
    """
    ...
    def __init__(
        ...
        """
        Initializes a new instance of the SYCLTemplateKernel class.
    ...
    def call_kernel(
        self,
        name: str,
        node: "SYCLTemplateBuffer",  # type: ignore[name-defined]
    ) -> None:
        """
        ...
        node: The SYCLTemplateBuffer node which contains information about the kernel, it's fused epilogue nodes
    ...
    def cutlass_dtype(self, node: IRNode, default_dtype="void") -> Optional[str]:
        ...
        from torch._inductor.codegen.xpu.sycl_template import CUTLASSTemplate
...
class SYCLTemplateCaller(ChoiceCaller):
    """
    SYCLTemplateCaller

    This class represents a caller for SYCL template kernels. It is a subclass of ChoiceCaller.
    Attributes:
        name (str): The name of the caller.
        category (str): The category of the caller.
        bmreq (SYCLBenchmarkRequest): The benchmark request for the caller.
        template_buffer (SYCLTemplateBuffer): The template buffer for the caller.
    """
    ...
    def call_name(self) -> str:
        return f"sycl_template_kernels.{self.name}"
    ...
    def info_dict(self) -> dict[str, Union[PrimitiveInfoType, list[PrimitiveInfoType]]]:
        ...
        if self.info_kwargs is not None and "op" in self.info_kwargs:
            ...
            return {"backend": "XPU", "op_type": "unknown"}
